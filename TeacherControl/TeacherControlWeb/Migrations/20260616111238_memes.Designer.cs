...
namespace TeacherControlWeb.Migrations
{
    ...
    [Migration("20260616111238_memes")]
    partial class memes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeacherControlWeb.Entities.BingoBoardEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TeacherControlWeb.Entities.BingoTileEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TeacherControlWeb.Entities.MemeEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TeacherControlWeb.Entities.BingoBoardEntity", b =>
                {
                    b.HasOne("TeacherControlWeb.Entities.UserEntity", "Winner")
                        .WithMany()
            ...
            modelBuilder.Entity("TeacherControlWeb.Entities.BingoTileEntity", b =>
                {
                    b.HasOne("TeacherControlWeb.Entities.BingoBoardEntity", "Board")
                        .WithMany("Tiles")
                        .HasForeignKey("BoardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TeacherControlWeb.Entities.UserEntity", "TriggeredByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TeacherControlWeb.Entities.ChatMessageEntity", b =>
                {
                    b.HasOne("TeacherControlWeb.Entities.MemeEntity", "Meme")
                        .WithMany()
